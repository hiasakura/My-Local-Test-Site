...
TNT.a.b = {
 ...
 "isProduction": true,
 "adminUrl": "//admin8.testandtarget.omniture.com/admin",
 "clientCode": "adobeinternalnoriota",
 "serverHost": "adobeinternalnoriota.tt.omtrdc.net",
 "mboxTimeout": 15000,
 ...
 "imsOrgId": "915B7D445370B4790A490D4D@AdobeOrg",
...
mboxFactory = function(Mb, rb, Nb) {
 ...
 this.Sb = this.Sb &&
 TNT.a.T.X(this.Vb.getCookie(H.D)) &&
 TNT.a.T.X(this.Vb.getCookie(H.K));
...
TNT.a.je = function(he, Nc, b, H, Vb) {
 ...
 var oe = function(pe){};
 var qe = function(pe){ ne(function() {he[ke].applyWhenReady(pe);}, me); };
