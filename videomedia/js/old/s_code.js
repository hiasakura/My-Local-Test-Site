...
var s_account="hiroasakvideoold"
var s=s_gi(s_account)

/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */
s.debugTracking=true
s.trackingServer="hirofumitestcompany.sin2.sc.omtrdc.net"
s.visitorNamespace="hirofumitestcompany.sin2.sc.omtrdc.net"
...
if(s.enableVideoTracking){
    s.loadModule("Media")
    s.Media.autoTrack = false;                // Always False for HTML5
    s.Media.trackWhilePlaying=true;
    s.Media.trackVars   = "events,eVar2,eVar3,eVar4";
    s.Media.trackEvents = "event2,event3,event4,event5,event6,event7,event8";
    s.Media.segmentByMilestones = true;       // Segment Auto Creation
    s.Media.trackMilestones = "25,50,75";     // Track Period
    s.Media.trackUsingContextData = true;     // SC v15 Video Reporting 
