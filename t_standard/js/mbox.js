...
mboxFactory.prototype.setVisitorIdParameters =  function(_url, _mboxName) {
  var imsOrgId = '915B7D445370B4790A490D4D@AdobeOrg';
...
if (typeof mboxVersion == 'undefined') {
  ...
  var mboxFactoryDefault = new mboxFactory('adobeinternalnoriota.tt.omtrdc.net', 'adobeinternalnoriota',
    'default');
};
...
if (mboxGetPageParameter("mboxDebug") != null ||
  ...
  document.write('<' + 'scr' + 'ipt language="Javascript1.2" src='
    + '"//admin8.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=adobeinternalnoriota.tt.omtrdc.net'
    + '&clientCode=adobeinternalnoriota"><' + '\/scr' + 'ipt>');
};
...
mboxVizTargetUrl = function(_mboxName /*, ... */) {
  ...
  _urlBuilder.setBasePath('/m2/' + 'adobeinternalnoriota' + '/viztarget');
